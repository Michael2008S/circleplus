...
contract BlockportPresale is CappedCrowdsale, TimedCrowdsale, Whitelist, Pausable {
    ...
    function BlockportPresale(uint256 _cap, uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet, ERC20 _tokenAddress)
...
//    }
    ...
    function setRate(uint256 _rateInWei, uint256 _capInWei, uint256 _minimalInvestmentInWei) public onlyOwner returns (bool) {
        ...
        // can't update anymore if sale already started
